...
def dataset_read(dataset, base_path, batch_size, n_parties, partition, beta, skew_class):
    ...
    net_dataidx_map, traindata_cls_counts, data_distributions, js_matrix = partition_data(partition, n_train, n_parties, train_label, beta, skew_class)
    ...
    return train_dataloaders, val_dataloaders, test_loader, net_dataidx_map, traindata_cls_counts, data_distributions, js_matrix
